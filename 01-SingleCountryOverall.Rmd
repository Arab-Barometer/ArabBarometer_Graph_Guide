...
```{r 01.14.5-Complete-Code-Example, echo=FALSE}
...
```{r 01.15-Complete-Code-Example-Results1, fig.dim=c(13,12)}
...
```{r 01.16-Complete-Code-Example-Results2, fig.dim=c(13,12)}
...
```{r 01.17-Complete-Code-Example-Results3, fig.dim=c(13,12)}
...
```{r 01.26-plots, figures-side, fig.show="hold", out.width="50%"}
map(
  summaries,            # List of summaries
  plot_smry_individual  # Plotting function
)
...
```{r 01.29-Complete-Code-Example-Results1, fig.dim=c(13,12)}
...
```{r 01.30-Complete-Code-Example-Results2, fig.dim=c(13,12)}
...
```{r 01.31-Complete-Code-Example-Results3, fig.dim=c(13,12)}
