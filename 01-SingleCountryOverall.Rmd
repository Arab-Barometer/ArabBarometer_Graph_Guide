...
```{r 01.2-Complete-Graph-Example, echo=FALSE, fig.dim=c(13,12),cache=TRUE,warning=FALSE,message=FALSE}

survey1 %>%
  calculate_smry_individual("Q1COVID19",
                            "Algeria") %>%
  plot_smry_individual(.caption = "Arab Barometer Wave VI, Survey I")
...
```{r 01.11-plot, echo=FALSE, fig.dim=c(13,12),cache=TRUE,warning=FALSE,message=FALSE}
...
```{r 01.13-plot, echo=FALSE, fig.dim=c(13,12),cache=TRUE,warning=FALSE,message=FALSE}
...
summaries <- map(variables_2_plot,
                 calculate_smry_individual,
                 .ab = survey1,
                 .country = "Algeria")
...
```{r 01.14.5-Complete-Code-Example, echo=FALSE,cache=TRUE,warning=FALSE,message=FALSE}
...
```{r 01.15-Complete-Code-Example-Results1, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
...
```{r 01.16-Complete-Code-Example-Results2, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
...
```{r 01.17-Complete-Code-Example-Results3, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
...
```{r 01.23-summaries, echo=FALSE,cache=TRUE,warning=FALSE,message=FALSE}
...
Again, the same function to create one plot is used to create many plots: `plot_smry_individual()`. Again, we are using the `map()` function.
...
map(
  ...
  plot_smry_individual  # Function (plotting function)
)
...
```{r 01.26-plots, figures-side, fig.show="hold", out.width="50%",cache=TRUE,message=FALSE}
map(
...
```{r 01.28.5-plots, echo=FALSE,cache=TRUE,message=FALSE,warning=FALSE}
plots <- map(
  summaries,                                     # List of summaries
  plot_smry_individual,                          # Plotting function
...
```{r 01.29-Complete-Code-Example-Results1, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
...
```{r 01.30-Complete-Code-Example-Results2, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
...
```{r 01.31-Complete-Code-Example-Results3, fig.dim=c(13,12),cache=TRUE,warning=FALSE}
