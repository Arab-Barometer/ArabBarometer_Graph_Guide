...
The `.ab` parameter is specifically referring to Arab Barometer data. The `calculate_` function will look for certain features in the data frame that are specific to Arab Barometer data. The section \@ref(#ab-data-description) provides more details on what an Arab Barometer data frame looks like.
