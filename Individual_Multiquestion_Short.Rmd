...
The parameters for including a title, subtitle, and caption are the same as they are in any other function: `.title`, `.subtitle`, and `.caption`, respectively. We can fill these in to create our final graphs.

```{r 09.10-second-graph-short, fig.dim=c(13,12)}
...
```{r 09.11-second-graph-long, fig.dim=c(13,12)}
