...
## Changing the cuttoff with a character string:
wave6survey1_en %>%
  education_demographic("BA") %>%
  select(education) %>%
  table()

## Changing the cuttoff with a numeric:
wave6survey1_en %>%
...
# English:
wave6survey1_en = wave6survey1_en %>%
...
# Arabic:
wave6survey1_ar = wave6survey1_ar %>%
