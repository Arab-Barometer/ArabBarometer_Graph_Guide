...
The function `calculate_demographic_smry_individual()` will produce a join message. You can read a bit about that [here](#messages-join).

The function `plot_demographic_smry_individual()` will produce a `position_dodge()` warning. You can read a bit about that [here](#warning-dodge).