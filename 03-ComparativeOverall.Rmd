...
The next step is plot the summary we just created. To do this, we use the function **plot_smry_comp()**. You can learn more about this function in section [7.3](https://arab-barometer.github.io/ArabBarometR-Guide/standard-plots.html#plot_smry_comp) of the ArabBarometR Guide.
