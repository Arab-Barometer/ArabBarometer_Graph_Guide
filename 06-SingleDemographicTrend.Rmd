# BARE BONES: Single Country Demographic Trend Graphs
...
```{r 06.1.1-Single-Trend,echo=T,eval=FALSE}
...
```{r 06.1.2-Single-Trend,echo=T,eval=FALSE}
...
### Plot a Demographic Trend Graph
...
```{r 06.3-First-Example, echo=FALSE, fig.dim=c(13,12)}
...
```{r 06.3.5-First-Example, echo=FALSE, fig.dim=c(13,12)}
...
```{r 06.4-Complete-Code-Example, eval=FALSE}
...
```{r 06.5-Many-Graphs-Example1, fig.dim=c(13,12)}
...
```{r 06.6-Many-Graphs-Example2, fig.dim=c(13,12)}
...
```{r 06.7-Many-Graphs-Example2, fig.dim=c(13,12)}

plots <- map(
  variables_2_plot, # Vector of variables to plot
  plot_trend_individual, # Map to function `plot_trend_individual_demographics()`
...
```{r 06.8-Many-Graphs-Example2, fig.dim=c(13,12)}
