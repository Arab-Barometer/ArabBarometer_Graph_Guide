...
```{r 08.11-Many-Graphs-Example1, fig.dim=c(13,12)}
...
```{r 08.12-Many-Graphs-Example2, fig.dim=c(13,12)}
...
```{r 08.13-Many-Graphs-Example2, fig.dim=c(13,12)}
...
```{r 08.14-Many-Graphs-Example2, fig.dim=c(13,12)}
